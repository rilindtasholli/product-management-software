    ...
    public class SalesController : ControllerBase
    {
        ...
        public JsonResult Get()
        {
            string query = @"select
                       sal_id, sal_date,
                       sal_client
                       from ProductManagementDB.Sales";
        ...
        {
            string query = @"insert into ProductManagementDB.Sales(sal_date)
                         values
                             (
                             '" + sal.Sal_date + @"'
                             )";
        ...
        {
            string query = @"update ProductManagementDB.Sales set
        ...
        {
            string query = @"delete from ProductManagementDB.Sales
                            where sal_id = " + id + @"
                            ";
